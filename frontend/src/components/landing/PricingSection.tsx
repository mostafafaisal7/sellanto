...
const PLANS: Plan[] = [
  {
    ...
    features: [
      { label: '5 Magic Mode runs / month', bold: true },
      { label: '10 AI images / month' },
      { label: '1 AI video / month' },
      { label: '2 connected platforms' },
  ...
  },
  {
    ...
    ctaVariant: 'primary',
    features: [
      { label: 'Unlimited Magic Mode runs', bold: true },
      { label: '200 AI images / month' },
      { label: '30 AI videos (Veo) / month' },
      { label: 'All 8 platforms connected' },
      { label: 'Smart-time scheduling' },
      { label: 'Unlimited AI captions' },
      { label: 'Messenger Bot automation' },
